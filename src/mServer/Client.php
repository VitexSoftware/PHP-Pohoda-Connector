...
class Client extends \Ease\Sand
{
    ...
    public function __construct($init = null, $options = [])
    {
        ...
        $this->xmlCache = sys_get_temp_dir() . '/' . Functions::randomString() . '.xml';
        if ($this->debug) {
            $this->addStatusMessage('XMLCache: ' . $this->xmlCache, 'debug');
        }
        if (!empty($init)) {
...
//                }
    ...
    public function addToPohoda($data = [])
    {
        ...
        if ($this->requestXml) {
            ...
            $added = $this->pohoda->addItem(2, $this->requestXml);
        }
        $this->pohoda->close();
