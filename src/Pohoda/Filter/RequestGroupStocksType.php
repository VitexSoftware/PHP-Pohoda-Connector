...
/**
 * Class representing RequestGroupStocksType
 *
 *
 * XSD Type: requestGroupStocksType
 */
class RequestGroupStocksType
{
     ...
     *
     * @var \Pohoda\Filter\FilterGroupStockType $filter
     */
    private $filter = null;
     ...
     * Seznam polí, podle kterých se budou filtrovat doklady.
     *
     * @return \Pohoda\Filter\FilterGroupStockType
     */
     ...
     * Seznam polí, podle kterých se budou filtrovat doklady.
     *
     * @param \Pohoda\Filter\FilterGroupStockType $filter
     * @return self
     */
    public function setFilter(?\Pohoda\Filter\FilterGroupStockType $filter = null)
    {
        $this->filter = $filter;
        return $this;
    }
